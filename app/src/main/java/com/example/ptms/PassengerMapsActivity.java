...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customerID = Prevelent.currentOnlineUser.getPhone();
        ...
        SettingsButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(PassengerMapsActivity.this, PasMenuActivity.class);
        ...
        CallCabCarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                if (requestType)
                {
                    ...
                    String customerId = Prevelent.currentOnlineUser.getPhone();
                    ...
                    CallCabCarButton.setText("Request a Pickup");
                ...
                else
                {
                    ...
                    CallCabCarButton.setText("Getting your Bus...");
                    getClosetDriverCab();
                }
            }
        });
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if(dataSnapshot.exists()  &&  requestType)
                        {
                            ...
                            CallCabCarButton.setText("Bus Found");
    ...
    {
        Intent startPageIntent = new Intent(PassengerMapsActivity.this, PasMenuActivity.class);
