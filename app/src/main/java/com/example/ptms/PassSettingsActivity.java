...
public class PassSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pasEmail = (EditText) findViewById(R.id.pas_email);
    ...
    private void updateOnlyUserInfo( ){
            ...
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("User").child("Passenger");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        else
        {
            ...
            startActivity(new Intent(PassSettingsActivity.this, PassSettingsActivity.class));
            finish();
        }
    }
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText, final EditText userPhoneEditText, final EditText addressEditText,final EditText pasEmail) {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("User").child("Passenger").child(Prevelent.currentOnlineUser.getPhone());
