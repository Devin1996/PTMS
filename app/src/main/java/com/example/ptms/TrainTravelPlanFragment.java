...
public class TrainTravelPlanFragment extends Fragment {
    ...
    public TrainTravelPlanFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater , ViewGroup container , Bundle savedInstanceState) {
        RequestsFragmentView = inflater.inflate(R.layout.train_travel_plan_fragment , container , false);
        ...
        confirmedBookingPlans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent confirmedBookingIntent = new Intent(getActivity() , ReadConfirmedTrainBooking.class);
                        ...
                        builder.setItems(options , new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog , int which) {
                                ...
                                if (which == 2) {
                                    ...
                                    Intent intent = new Intent(getActivity() , ConfirmFinalTrainBookingActivity.class);
                                    intent.putExtra("timeSlotKey" , model.getTimeSlotKey());
                                    startActivity(intent);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (shippingState.equals("Reserved")) {
                        ...
                        txtTotalAmount.setText("State = Not Reserved");
                        recyclerView.setVisibility(View.GONE);
